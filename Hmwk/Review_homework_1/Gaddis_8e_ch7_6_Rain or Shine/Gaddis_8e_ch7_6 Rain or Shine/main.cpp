...
string comp_Rep(int,int,char[][30]);
...
int main() {
    ...
    inFile.close();
    cout << "Here's a display of all the data inside the txt file:\n";
    for (countROW=0; countROW<3; countROW++){
        for(countCOL=0; countCOL<30; countCOL++){
    ...
    mostRain = comp_Rep(countROW,countCOL,isWther);
...
string comp_Rep(int countROW,int countCOL,char isWther[][30]){
